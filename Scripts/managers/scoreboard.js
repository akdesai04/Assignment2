...
(function (managers) {
    var ScoreBoard = /** @class */ (function () {
        ...
        ScoreBoard.prototype.Start = function () {
            ...
            this._scoreLabel = new objects.Label("Score: 99999", "30px", "Kirang Haerang", "#FFFF00", 500, 20, false);
            this._highScoreLabel = new objects.Label("High Score: 99999", "60px", "Kirang Haerang", "#FFFF00", config.Screen.HALF_WIDTH + 70, config.Screen.HALF_HEIGHT, true);
            this.HighScore = 0;
            this.Reset();
        };
